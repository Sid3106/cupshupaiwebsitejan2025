...
import { Country } from './types'; // Ensure you have an interface { code: string; name: string; dialCode: string; flag: string; }
...
export const countries: Country[] = [
  ...
  { code: 'BV', name: 'Bouvet Island', dialCode: '', flag: '🏳️' }, // Usually uninhabited
  { code: 'BR', name: 'Brazil', dialCode: '55', flag: '🇧🇷' },
  ...
  { code: 'HM', name: 'Heard Island and McDonald Islands', dialCode: '', flag: '🏳️' },
  ...
  { code: 'KP', name: "Korea, Democratic People's Republic of (North Korea)", dialCode: '850', flag: '🇰🇵' },
  { code: 'KR', name: 'Korea, Republic of (South Korea)', dialCode: '82', flag: '🇰🇷' },
  { code: 'KW', name: 'Kuwait', dialCode: '965', flag: '🇰🇼' },
  { code: 'KG', name: 'Kyrgyzstan', dialCode: '996', flag: '🇰🇬' },
  { code: 'LA', name: "Lao People's Democratic Republic (Laos)", dialCode: '856', flag: '🇱🇦' },
  ...
  { code: 'SG', name: 'Singapore', dialCode: '65', flag: '🇸🇬' },
  { code: 'SX', name: 'Sint Maarten (Dutch part)', dialCode: '1-721', flag: '🇸🇽' },
  ...
  { code: 'TR', name: 'Türkiye (Turkey)', dialCode: '90', flag: '🇹🇷' },
  ...
  { code: 'GB', name: 'United Kingdom', dialCode: '44', flag: '🇬🇧' },
  { code: 'US', name: 'United States', dialCode: '1', flag: '🇺🇸' },
  { code: 'UM', name: 'United States Minor Outlying Islands', dialCode: '', flag: '🏳️' },
